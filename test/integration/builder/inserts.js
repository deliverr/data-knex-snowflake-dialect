...
module.exports = function (knex) {
  describe("Inserts", function () {
        ...
        .then(function () {
          return knex("test_default_table")
            ...
            .testSql(function (tester) {
              ...
              tester("pg", 'insert into "test_default_table" default values returning "id"', [], [1]);
              ...
              tester("mssql", "insert into [test_default_table] output inserted.[id] default values", [], [1]);
            });
        });
    });
        ...
        .then(function () {
          return knex("test_default_table2")
            ...
            .testSql(function (tester) {
              ...
              tester("pg", 'insert into "test_default_table2" default values returning "id"', [], [1]);
              ...
              tester("mssql", "insert into [test_default_table2] output inserted.[id] default values", [], [1]);
            });
        });
    });
    ...
    describe("batchInsert (TODO: fix random oracle fail)", function () {
      ...
      const fiftyLengthString = "rO8F8YrFS6uoivuRiVnwrO8F8YrFS6uoivuRiVnwuoivuRiVnw";
      const items = [];
    ...
    it("should replace undefined keys in multi insert with DEFAULT", function () {
      ...
      return knex("accounts")
        ...
        .then(function () {
          return knex("accounts")
            .whereIn("email", ["single-test1@example.com", "double-test1@example.com"])
            .orderBy("email", "desc");
        })
