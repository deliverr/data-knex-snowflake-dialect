...
module.exports = function (knex) {
  describe("Additional", function () {
    ...
    it("should forward the .mapSeries() function from Promise", function () {
    ...
    it("should forward the .delay() function from Promise", function () {
    ...
    it("should truncate a table with truncate", function () {
      return knex("test_table_two")
        ...
        .then(() => {
          ...
          if (/oracle/i.test(knex.client.driverName) || /redshift/i.test(knex.client.driverName)) {
            return;
          }
          return knex("test_table_two")
            .insert({ status: 1 })
